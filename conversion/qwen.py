...
class _Qwen35MtpMixin:
    ...
    def prepare_metadata(self, vocab_only: bool):
        ...
        from_dir = self.fname_out.is_dir()  # ty: ignore[unresolved-attribute]
        ...
        self.fname_out = self.fname_out.parent / f"mtp-{fname_default}.gguf"  # ty: ignore[unresolved-attribute]
